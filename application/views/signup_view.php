    ...
    <div class="row">
        ...
        <div class="col-xs-12 .col-md-8-centered well">
             <div class="text-right">
                <br>
                <a 
                    href="<?php echo site_url(); ?>/Login_Controller/" >Login
                </a>
            </div>
            ...
            <fieldset>
                    ...
                    <div class="row colbox">
                        <div class="col-xs-12 .col-md-8">
                            ...
                            <input 
                                ...
                                placeholder="Name" 
                                type="text" 
                                value="<?php echo set_value('txt_empname'); ?>" 
                            /> 
                    ...
                    <div class="row colbox">
                        <div class="col-xs-12 .col-md-8">
                            ...
                            <input 
                                ...
                                placeholder="Address" 
                                type="text" 
                                value="<?php echo set_value('txt_emp_addr'); ?>" 
                            />  
                ...
                <div class="form-group">
                    <div class="row colbox">
                        <div class="col-xs-12 .col-md-8">
                            <label for="txt_username" class="control-label">Login username</label>
                            <input 
                                class="form-control" 
                                id="txt_username" 
                                name="txt_username" 
                    ...
                    <div class="row colbox">
                        <div class="col-xs-12 .col-md-8">
                            ...
                            <input 
                                ...
                                type="password" 
                                value="<?php echo set_value('txt_confirm_password'); ?>"
                            /> 
                    ...
                    <div class="row colbox">
                        <div class="col-xs-12 .col-md-8">
                            <input 
                                ...
                                name="btn_signup" 
                                type="submit" 
                                class="btn btn-primary col-xs-12 .col-md-8" 
                                value="Signup" 
                            />
                            <br><br>
                            <input 
                                ...
                                id="btn_reset" 
                                name="btn_reset" 
                                class="btn btn-default col-xs-12 .col-md-8" 
                                value="Cancel"
                            />
                        </div>
                    </div>
